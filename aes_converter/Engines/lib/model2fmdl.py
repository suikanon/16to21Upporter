...
def convertMaterials(model, sourceDirectory, modelType=None, modelCategory=None, mtl=None):
    """
...
def convertModel(model, sourceDirectory, modelType=None, modelCategory=None, mtl=None):
    """
    ...
    # 1. Materials
    materialInstances = convertMaterials(model, sourceDirectory, modelType, modelCategory, mtl)
